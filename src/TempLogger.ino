...
// v1.24 - Added Seeed HM330 PM 2.5 Sensor


const char releaseNumber[6] = "1.24"; // Displays the release on the menu
...
void sendUBIDots()                                                                // Function that sends the JSON payload to Ubidots
{
  ...
  snprintf(data, sizeof(data), "{\"Temperature\":%3.1f, \"Battery\":%3.1f, \"Humidity\":%3.1f, \"PM2.5\":%3.1f, \"PM1\":%3.1f, \"PM10\":%3.1f}", sensor_data.temperatureInC, sensor_data.batteryVoltage, sensor_data.humidity, sensor_data.pm2_5, sensor_data.pm1_0,sensor_data.pm10_0);
